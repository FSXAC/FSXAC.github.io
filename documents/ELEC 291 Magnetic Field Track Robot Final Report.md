# Magnetic Field Track Robot Final Report
...
![g4202](assets/ELEC291P2 Report/g4202.png)

*Figure 3.1: Joystick Controls*
...
*Table 3.1: Testing Different Inductor Configurations*
...
*Table 3.2: PWM Methods for Right Motor*
...
*Table 3.4: Visualization of Signal in the Guide Wire During Commands Transmission*

| Command | Received Signal                          | Bits   | Description                              |
| :------ | ---------------------------------------- | ------ | ---------------------------------------- |
| 0       | ![](assets/ELEC291P2 Report/squareCmd0.png) | 11-111 | No command                               |
| 1       | ![](assets/ELEC291P2 Report/squareCmd1.png) | 01-001 | Turn left at the next detected intersection |
| 2       | ![](assets/ELEC291P2 Report/squareCmd2.png) | 01-010 | Turn right at the next detected intersection |
| 3       | ![](assets/ELEC291P2 Report/squareCmd3.png) | 01-011 | Switch to tracking forward               |
| 4       | ![](assets/ELEC291P2 Report/squareCmd4.png) | 01-100 | Switch to tracking backward              |
| 5       | ![](assets/ELEC291P2 Report/squareCmd5.png) | 01-101 | U-Turn (turn 180 degrees)                |
| 6       | ![](assets/ELEC291P2 Report/squareCmd6.png) | 01-110 | Stop                                     |
...
![gw0](assets/ELEC291P2 Report/gw0.JPG)

*Figure B.1: Part 1 of the guide wire generator circuit: connections to the USB adapter*

![gw1](assets/ELEC291P2 Report/gw1.JPG)

*Figure B.2: Part 2 of the guide wire generator circuit: connections to all added components*

### C. Robot Circuit

![rcc0](assets/ELEC291P2 Report/rcc0.JPG)

*Figure C.1: Combined Tank, OpAmp and Peak Detector Circuit*

![rcc1](assets/ELEC291P2 Report/rcc1.GIF)

*Figure C.2: Comparator and Rectifier Circuit as Receiver*

![rcc2](assets/ELEC291P2 Report/rcc2.JPG)

*Figure C.3: Single H-Bridge Circuit*

![rcc3](assets/ELEC291P2 Report/rcc3.png)

*Figure C.4: Oscilloscope Output for Robot Controller Received Signals*

### D. Robot Logic

![logic (copy)](assets/ELEC291P2 Report/logic (copy).jpg)

*Figure D.1: Logic Diagram for Robot Controller*
...
*Table E.2: Consistency Test Data for Forward Tracking*
...
*Table E.3: Consistency Test Data for Backward Tracking*
